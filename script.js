...
function setupCodeCarousels() {
  document.querySelectorAll("[data-code-carousel]").forEach((carousel) => {
    const slides = Array.from(carousel.querySelectorAll("[data-code-slide]"));
    const previous = carousel.querySelector("[data-code-previous]");
    const next = carousel.querySelector("[data-code-next]");
    const title = carousel.querySelector("[data-code-title]");
    const count = carousel.querySelector("[data-code-count]");
